$(document).ready(function(){
    ...
    $("#state").text(s.state);
    $("#frame-number").text(s.frameNumber());
    $("#balls-rolled").text(s.rolls);
    $("#rolling-frame").text(s.rollingFrame);
    $("#total-score").text(s.totalScore);
    $("#first-ball").text(s.firstBallInFrame);
    $("#game-over").text(s.gameIsOver());
    $(":button").click(function(){
        s.roll(Number($(this).val()));
        // displayButtons(s.state, s.firstBallInFrame);
        $("#state").text(s.state);
        $("#frame-number").text(s.frameNumber());
        $("#balls-rolled").text(s.rolls);
